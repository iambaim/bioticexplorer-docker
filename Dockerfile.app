...
RUN  apt-get update \
  ...
  && Rscript --vanilla  -e "library(checkpoint); setSnapshot(\"2021-03-24\"); source(\"/BioticExplorer/install_requirements.R\")" \
  # Database processor
  ...
  && Rscript --vanilla  -e "library(checkpoint); setSnapshot(\"2021-03-24\"); install.packages(\"remotes\"); remotes::install_deps(); remotes::install_local()" \
